...
*/
//$route['(:any)'] = 'showPage/index/$1';
//$route['get/(:any)'] = 'get/$1';
//$route['gete/(:any)'] = 'gete/$1';
//$route['admin/(:any)'] = 'adminPage/index/$1';
//$route['admin/get/(:any)'] = 'admin/$1';
//$route['admin/code/(:any)'] = 'code/$1';
//$route['admin/request/edit/(:any)'] = 'request/edit/$1';
//$route['admin/user/(:any)'] = 'user/$1';
$route['default_controller'] = 'showPage';
$route['404_override'] = 'errors/page_missing';
$route['translate_uri_dashes'] = FALSE;
